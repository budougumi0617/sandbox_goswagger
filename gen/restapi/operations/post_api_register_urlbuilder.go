...
func (o *PostAPIRegisterURL) Build() (*url.URL, error) {
	...
	hogeIDQ := swag.FormatInt64(o.HogeID)
	if hogeIDQ != "" {
		qs.Set("hoge_id", hogeIDQ)
	}
...
func (o *PostAPIRegisterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostAPIRegisterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostAPIRegisterURL")
	}
